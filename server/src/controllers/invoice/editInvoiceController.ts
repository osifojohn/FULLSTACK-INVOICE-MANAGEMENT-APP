...
import { cloudinaryDestroyAndUpdateStreamFn } from '../../utils/cloudinaryAndDbFns';
      ...
      readStream.on('open', () => {
        ...
        readStream.pipe(
          cloudinaryDestroyAndUpdateStreamFn(
            ...
            editInvoiceDetails as invoiceDetailsType,
            latestInvoice as InvoiceType & { invoiceNumber: string }
          )
        );
